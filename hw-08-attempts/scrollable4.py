...
class AppGui:
    ...
    def setFrameGridConfigs(self):
        ...
        self.searchFrame.columnconfigure(2, weight=4)
    ...
    def onAddEntrySection(self):
        ...
        self.nameLabel = ttk.Label(
            self.addFrame, text="Name", font="Helvetica 12 bold")
        self.emailLabel = ttk.Label(
            self.addFrame, text="Email", font="Helvetica 12 bold")
        ...
        self.addNewEntryBtn.bind('<Return>', self.addNewEntry)
    ...
    def onAddSearchSection(self):
        ...
        self.searchResultLabel = ttk.Label(
            self.searchFrame, textvariable=self.searchResult, font="Helvetica 12 bold")
        ...
        self.addSearchLabel.grid(row=0, column=1, sticky=(
            N, E, W))
        self.searchEntry.grid(row=1, column=1, sticky=(
            N, E, W), pady=2, padx=(15, 7.5))
    ...
    def deleteEntry(self, event, name, email):
        ...
        print("[NUMBER]", self.entriesFrameNum)
        print("[MASTER]", str(parentFame))
        print("[BUTTON]",self.master.children[parentFame].children["!canvas"].children["!frame"])
    ...
    def onEntryInteraction(self, event):
        ...
        if event.keycode == 13:
            ...
            for name, email in self.dataSet.items():
                ...
                if name == self.newEntryVal:
                    isNameInDataset = True

                    print(event.num, event.keycode, name, email, self.currentEntryVal, self.newEntryVal)
                    break
                elif email == self.newEntryVal:
            ...
            if answer == False:
                ...
                if not isNameInDataset:
                    print(nameInDataset, emailInDataset)
                    emailInDataset = self.dataSet[nameInDataset]
